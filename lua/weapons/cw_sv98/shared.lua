...
if CLIENT then
	...
	SWEP.NXSPos = Vector(-2.77, 0.75, 0.75)
	SWEP.NXSAng = Vector(0, 0, 0)
	
	SWEP.ACOGPos = Vector(-2.77, -2.5, 0.45)
	SWEP.ACOGAng = Vector(0, 0, 0)
	
	SWEP.ShortDotPos = Vector(-2.77, 0.5, 0.6)
