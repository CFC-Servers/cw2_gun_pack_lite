...
if CustomizableWeaponry_KK_HK416 and CustomizableWeaponry_G4P_UECW and CustomizableWeaponry_WS_Pack then
	SWEP.Attachments = {[1] = {header = "Sight", offset = {50, -400}, atts = {"md_microt1", "md_cmore", "md_ws_c_more", "md_reflex", "md_cod4_reflex", "md_ws_barska", "md_trijicon", "md_eotech", "md_fas2_eotech", "md_ws_eotech557", "md_fas2_holo", "md_aimpoint", "md_fas2_aimpoint"}},
...
elseif CustomizableWeaponry_WS_Pack and CustomizableWeaponry_KK_HK416 then
	SWEP.Attachments = {[1] = {header = "Sight", offset = {150, -400}, atts = {"md_microt1", "md_ws_c_more", "md_cod4_reflex", "md_ws_barska", "md_eotech", "md_fas2_eotech", "md_ws_eotech557", "md_fas2_holo", "md_aimpoint", "md_fas2_aimpoint"}},
		[2] = {header = "Barrel", offset = {-300, -200}, atts = {"md_tundra9mm", "md_ws_scifi_silencer"}},
		[3] = {header = "Stock", offset = {950, 350}, atts = {"bg_tr09_mp9_stock"}},
		["impulse 100"] = {header = "Skin", offset = {950, 0}, atts = {"bg_tr09_mp9_tan", "bg_tr09_mp9_chromosynth"}},
		["+reload"] = {header = "Ammo", offset = {-300, 250}, atts = {"am_magnum", "am_matchgrade"}}
...
elseif CustomizableWeaponry_G4P_UECW and CustomizableWeaponry_KK_HK416 then
	SWEP.Attachments = {[1] = {header = "Sight", offset = {150, -400}, atts = {"md_microt1", "md_cmore", "md_reflex", "md_cod4_reflex", "md_trijicon", "md_eotech", "md_fas2_eotech", "md_fas2_holo", "md_aimpoint", "md_fas2_aimpoint"}},
...
elseif CustomizableWeaponry_KK_HK416 then
	SWEP.Attachments = {[1] = {header = "Sight", offset = {200, -400}, atts = {"md_microt1", "md_cod4_reflex", "md_eotech", "md_fas2_eotech", "md_fas2_holo", "md_aimpoint", "md_fas2_aimpoint"}},
		[2] = {header = "Barrel", offset = {-300, -200}, atts = {"md_tundra9mm"}},
		[3] = {header = "Stock", offset = {950, 350}, atts = {"bg_tr09_mp9_stock"}},
		["impulse 100"] = {header = "Skin", offset = {950, 0}, atts = {"bg_tr09_mp9_tan", "bg_tr09_mp9_chromosynth"}},
		["+reload"] = {header = "Ammo", offset = {-300, 250}, atts = {"am_magnum", "am_matchgrade"}}
